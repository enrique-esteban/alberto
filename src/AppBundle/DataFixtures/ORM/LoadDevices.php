...
class LoadDevices extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $device->setBrand($this->getReference('brand-samsung'));
        ...
        $device->setBrand($this->getReference('brand-apple'));
        $device->setModel('iPhone 7');
        $device->setWebPage('https://www.apple.com/es/idevice-7/');

        $this->addReference('device-idevice-7', $device);
        $manager->persist($device);
        ...
        $this->addReference('device-idevice-7-plus', $device);
        $manager->persist($device);
        ...
        $this->addReference('device-idevice-6s', $device);
        $manager->persist($device);
        ...
        $device->setWebPage('https://www.apple.com/es/idevice-se/');

        $this->addReference('device-idevice-se', $device);
        $manager->persist($device);
        ...
        $device->setBrand($this->getReference('brand-oppo'));
        $device->setModel('R9s');
        $device->setWebPage('http://www.oppo.com/en/smartdevice-r9s/');
        ...
        $device->setBrand($this->getReference('brand-huawei'));
        ...
        $device->setBrand($this->getReference('brand-bq'));
        ...
        $device->setBrand($this->getReference('brand-moto'));
